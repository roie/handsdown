...
const conversionCases = [
  ...
  ['HTML headings preserve boundaries', '<h2>Title</h2><p>Body</p>', 'Title\n\nBody'],
  ['HTML list items preserve lines', '<ul><li>First</li><li>Second</li></ul>', 'First\nSecond'],
  ['HTML table cells and rows preserve boundaries', '<table><tr><th>A</th><th>B</th></tr><tr><td>1</td><td>2</td></tr></table>', 'A\tB\n1\t2'],
  ['anchor preserves inner HTML break', '<a href="https://example.com">First<br>Second</a>', 'First\nSecond example.com'],
